<h3><span class='fa fa-bullhorn'></span>Չհաստատված ակցիաներ</h3><hr>
@if(($coupons->count() == 0))
<span class='fa fa-check-circle'></span><span>Չհաստատված կտրոններ դեռևս չկան</span>
@endif
@foreach($coupons as $coupon)
<div class='coupon-listing-header'>
<a class='fa fa-eye tag-icon btn btn-primary' data-id=0 style="font-size:14px;"></a><span style="font-size:20px;">{{$coupon->created_at." / ".$coupon->user->company_name}}</span>
